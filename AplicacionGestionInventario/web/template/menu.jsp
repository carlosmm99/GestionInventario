...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="nav-link" aria-current="page" href="${pageContext.servletContext.contextPath}/Inicio">
            <img class="imagen-hover" src="${pageContext.servletContext.contextPath}/img/202210_Logo _CEDEX_GRIS_web.jpg" style="width: 373.6px; height: 51.5px;"/>
        </a>
