<%-- 
    Document   : fungibles
    Created on : 12 feb. 2024, 11:50:47
...
<html>
    ...
    <body>
        <%
            Integer ultimoNumFungible = (Integer) request.getAttribute("ultimoNumFungible");
            Integer cantidadFungibles = (Integer) request.getAttribute("cantidadFungibles");
        %>
        <div class="container">
